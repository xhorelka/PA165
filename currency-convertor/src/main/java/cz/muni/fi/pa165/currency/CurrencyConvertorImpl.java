    ...
    public BigDecimal convert(Currency sourceCurrency, Currency targetCurrency, BigDecimal sourceAmount) {
        ...
        try {
            ...
            if (exchangeRate == null) {
                logger.warn("ExchangeRate is unknown for {} to {}", sourceCurrency, targetCurrency);
            ...
            logger.error("ExternalServiceFailureException when fetching exchange rate", e);
            throw new UnknownExchangeRateException("Error when fetching exchange rate", e);
        }
    }
